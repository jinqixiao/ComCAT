...
def split_to_factors(feature_size, dim):
    ...
    # f = int(np.power(feature_size, 1.0 / dim))
    # core = [f] * dim
    # for j in range(dim):
    #     core[j] += 1
    #     if np.prod(core) < feature_size:
    #         core[j] += 1
    #     if np.prod(core) >= feature_size:
    #         j += 1
    #         while dim > j:
    ...
    #         break
    #
    # # print(np.prod(core) - feature_size)
    #
    # return list(np.sort(core)[::-1])
...
if __name__ == '__main__':
    aa = [192, 192 * 2, 192 * 4, 192 * 8, 192 * 16]
    for a in aa:
        print(a)
        print(split_to_factors(a, 4))
        print(split_to_factors(a, 5))
        print(split_to_factors(a, 6))
